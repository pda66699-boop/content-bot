...
CTA_LIBRARY = {
    ...
    "hard": [
        "Если видишь, что бизнес уже упирается не в локальную задачу, а в саму конструкцию управления, можно обсудить «Бизнес без потерь» — 60-дневный спринт.",
        "Если понимаешь, что здесь уже нужен не совет, а быстрая пересборка системы, логичный следующий шаг — «Бизнес без потерь» — 60-дневный спринт.",
    ],
}
