...
def annotate_post(post: NormalizedTelegramPost) -> NormalizedTelegramPost:
    ...
    if any(
        ...
        for token in (
            "без тебя",
            "без вас",
            "ни одно важное решение",
            "держит все на себе",
            "держит всё на себе",
            "одном человеке",
            "личная вовлеченность собственника",
            "личная вовлеченность владельца",
            "личная вовлеченность подменяет",
            "подменяет собой систему",
        )
    ):
        post.primary_theme = "зависимость бизнеса от собственника"
        post.core_thesis = "Когда ключевые решения и эскалации держатся на собственнике, бизнес упирается в его внимание, а не в систему управления."
        return post
